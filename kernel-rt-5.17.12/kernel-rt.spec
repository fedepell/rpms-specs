...
Summary: The Linux kernel, with preempt-rt configuration
...
%define specrelease 100.rt%{?buildid}%{?dist}
...
%endif
Patch2: x86__Allow_to_enable_RT.patch
Patch3: 0057-smp-Wake-ksoftirqd-on-PREEMPT_RT-instead-do_softirq.patch
Patch4: 0103-net-core-use-local_bh_disable-in-netif_rx_ni.patch
Patch5: kernel_sched__add_putget_cpu_light.patch
Patch6: block_mq__do_not_invoke_preempt_disable.patch
Patch7: mm__workingset__replace_IRQ-off_check_with_a_lockdep_assert..patch
...
%endif
ApplyOptionalPatch x86__Allow_to_enable_RT.patch
ApplyOptionalPatch 0057-smp-Wake-ksoftirqd-on-PREEMPT_RT-instead-do_softirq.patch
ApplyOptionalPatch 0103-net-core-use-local_bh_disable-in-netif_rx_ni.patch
ApplyOptionalPatch kernel_sched__add_putget_cpu_light.patch
ApplyOptionalPatch block_mq__do_not_invoke_preempt_disable.patch
ApplyOptionalPatch mm__workingset__replace_IRQ-off_check_with_a_lockdep_assert..patch
...
#
%changelog
* Fri Oct 14 2022 Federico Pellegrin <fede@evolware.org> [5.17.12-0-rt]
- Make the kernel configuration PREEMPT-RT like
- Add minimal patches still needed for proper PREEMPT-RT build and execution
